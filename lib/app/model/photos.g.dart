...
_$UserImpl _$$UserImplFromJson(Map<String, dynamic> json) => _$UserImpl(
      ...
      totalPromotedPhotos: json['totalPromotedPhotos'] as int?,
...
_$TopicSubmissionsImpl _$$TopicSubmissionsImplFromJson(
    ...
    _$TopicSubmissionsImpl(
      ...
      wallpapers: json['wallpapers'] == null
          ? null
          : Travel.fromJson(json['wallpapers'] as Map<String, dynamic>),
      nature: json['nature'] == null
          ? null
          : The3DRenders.fromJson(json['nature'] as Map<String, dynamic>),
      the3DRenders: json['the3DRenders'] == null
          ? null
          : The3DRenders.fromJson(json['the3DRenders'] as Map<String, dynamic>),
    );
...
Map<String, dynamic> _$$TopicSubmissionsImplToJson(
    ...
    <String, dynamic>{
      ...
      'the3DRenders': instance.the3DRenders,
    };

_$The3DRendersImpl _$$The3DRendersImplFromJson(Map<String, dynamic> json) =>
    _$The3DRendersImpl(
      status: json['status'] as String?,
    );

Map<String, dynamic> _$$The3DRendersImplToJson(_$The3DRendersImpl instance) =>
    <String, dynamic>{
